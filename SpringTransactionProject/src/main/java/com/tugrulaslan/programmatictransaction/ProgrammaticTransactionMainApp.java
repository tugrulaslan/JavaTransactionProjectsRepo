...
public class ProgrammaticTransactionMainApp {
    public static void main(String[] args) {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("programmatic-transaction-beans.xml");
