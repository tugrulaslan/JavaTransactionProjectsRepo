...
public class DeclarativeTransactionAnnotationMainApp {
    public static void main(String[] args) {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("declarative-transaction-annotation-beans.xml");
